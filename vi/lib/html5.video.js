...
$pyjs['loaded_modules']['html5.video'] = function (__mod_name__) {
	...
	$m.__track_lines__[1] = 'html5.video.py, line 1:\n    from html5.widget import Widget';
	$m.__track_lines__[2] = 'html5.video.py, line 2:\n    from html5.html5Attr.src import Src';
	$m.__track_lines__[3] = 'html5.video.py, line 3:\n    from html5.html5Attr.media import Dimensions,Multimedia';
	$m.__track_lines__[4] = 'html5.video.py, line 4:\n    class Video( Widget,Src,Dimensions,Multimedia ):';
	$m.__track_lines__[5] = 'html5.video.py, line 5:\n    _baseClass = "video"';
	$m.__track_lines__[7] = 'html5.video.py, line 7:\n    def __init__(self, *args, **kwargs):';
	$m.__track_lines__[8] = 'html5.video.py, line 8:\n    super(Video,self).__init__( *args, **kwargs )';
	$m.__track_lines__[10] = 'html5.video.py, line 10:\n    def _getPoster(self):';
	$m.__track_lines__[11] = 'html5.video.py, line 11:\n    return self.element.poster';
	$m.__track_lines__[12] = 'html5.video.py, line 12:\n    def _setPoster(self,val):';
	$m.__track_lines__[13] = 'html5.video.py, line 13:\n    self.element.poster=val';


	$pyjs['track']['module']='html5.video';
	$pyjs['track']['lineno']=1;
	$pyjs['track']['lineno']=1;
	...
	$m['Video'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$pyjs['track']={'module':'html5.video', 'lineno':7};$pyjs['trackstack']['push']($pyjs['track']);
			$pyjs['track']['module']='html5.video';
			$pyjs['track']['lineno']=7;
			$pyjs['track']['lineno']=8;
			(function(){try{try{$pyjs['in_try_except'] += 1;
			return $pyjs_kwargs_call((function(){try{try{$pyjs['in_try_except'] += 1;
			return $p['$$super']($m['Video'], self);
	...
	, 1, ['args',['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('_getPoster', function() {
			...
			$pyjs['track']={'module':'html5.video', 'lineno':10};$pyjs['trackstack']['push']($pyjs['track']);
			$pyjs['track']['module']='html5.video';
			$pyjs['track']['lineno']=10;
			$pyjs['track']['lineno']=11;
			$pyjs['track']['lineno']=11;
			var $pyjs__ret = $p['getattr']($p['getattr'](self, 'element'), 'poster');
			$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
			return $pyjs__ret;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_setPoster', function(val) {
			...
			$pyjs['track']={'module':'html5.video', 'lineno':12};$pyjs['trackstack']['push']($pyjs['track']);
			$pyjs['track']['module']='html5.video';
			$pyjs['track']['lineno']=12;
			$pyjs['track']['lineno']=13;
			$p['getattr'](self, 'element')['poster'] = val;
			$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
			return null;
		}
