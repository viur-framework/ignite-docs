...
$pyjs['loaded_modules']['html5.object'] = function (__mod_name__) {
	...
	try {
		...
		$m['Object'] = (function(){
			...
			$cls_definition['__md5__'] = '68c0f7c5bdd861a528c07d6ef2b510a2';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '68c0f7c5bdd861a528c07d6ef2b510a2') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Object'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
