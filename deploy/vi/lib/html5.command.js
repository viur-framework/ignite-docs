...
$pyjs['loaded_modules']['html5.command'] = function (__mod_name__) {
	...
	try {
		...
		$m['Command'] = (function(){
			...
			$cls_definition['__md5__'] = '8b6ef0d5ac62ab1836485e6867370c47';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '8b6ef0d5ac62ab1836485e6867370c47') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Command'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('_getIcon', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'icon');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setIcon', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('icon', val) : $p['setattr']($p['getattr'](self, 'element'), 'icon', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getRadiogroup', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'radiogroup');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setRadiogroup', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('radiogroup', val) : $p['setattr']($p['getattr'](self, 'element'), 'radiogroup', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
