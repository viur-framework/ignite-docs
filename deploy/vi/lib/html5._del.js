...
$pyjs['loaded_modules']['html5._del'] = function (__mod_name__) {
	...
	try {
		...
		$m['_Del'] = (function(){
			...
			$cls_definition['__md5__'] = 'ba83cb53728279658452c04c8b970ce5';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'ba83cb53728279658452c04c8b970ce5') {
				...
				$pyjs_kwargs_call($p['$$super']($m['_Del'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
