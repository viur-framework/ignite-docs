...
$pyjs['loaded_modules']['html5.link'] = function (__mod_name__) {
	...
	try {
		...
		$m['Link'] = (function(){
			...
			$cls_definition['__md5__'] = '7ea0d50a9a2c060696fceb1818c87127';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '7ea0d50a9a2c060696fceb1818c87127') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Link'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('_getSizes', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'sizes');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setSizes', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('sizes', val) : $p['setattr']($p['getattr'](self, 'element'), 'sizes', val); 
				return null;
			}
