...
$pyjs['loaded_modules']['html5.span'] = function (__mod_name__) {
	...
	try {
		...
		$m['Span'] = (function(){
			...
			$cls_definition['__md5__'] = '03b9564f7fd1874d9ebafb2a2c2401bd';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '03b9564f7fd1874d9ebafb2a2c2401bd') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Span'], self), '__init__', null, kwargs, [{}]);
