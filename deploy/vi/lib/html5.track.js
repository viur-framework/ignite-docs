...
$pyjs['loaded_modules']['html5.track'] = function (__mod_name__) {
	...
	try {
		...
		$m['Track'] = (function(){
			...
			$cls_definition['__md5__'] = 'a2b10a9d5890a727fec0021cee5f3e2d';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'a2b10a9d5890a727fec0021cee5f3e2d') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Track'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('_getKind', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'kind');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setKind', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('kind', val) : $p['setattr']($p['getattr'](self, 'element'), 'kind', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getSrclang', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'srclang');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setSrclang', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('srclang', val) : $p['setattr']($p['getattr'](self, 'element'), 'srclang', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getDefault', function() {
				...
				return ($p['bool'](self['element']['hasAttribute']('default'))? (true) : (false));
			}
	, 1, [null,null,['self']]);
