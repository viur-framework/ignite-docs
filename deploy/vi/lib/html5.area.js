...
$pyjs['loaded_modules']['html5.area'] = function (__mod_name__) {
	...
	try {
		...
		$m['Area'] = (function(){
			...
			$cls_definition['__md5__'] = '1bfdae63521893bd9784ebbd2bb78f36';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '1bfdae63521893bd9784ebbd2bb78f36') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Area'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('_getCoords', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'coords');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setCoords', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('coords', val) : $p['setattr']($p['getattr'](self, 'element'), 'coords', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getShape', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'shape');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setShape', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('shape', val) : $p['setattr']($p['getattr'](self, 'element'), 'shape', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
