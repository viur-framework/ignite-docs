...
$pyjs['loaded_modules']['html5.progress'] = function (__mod_name__) {
	...
	try {
		...
		$m['Progress'] = (function(){
			...
			$cls_definition['__md5__'] = '23ffb71db1db9c64f785fb0e3040ffcc';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '23ffb71db1db9c64f785fb0e3040ffcc') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Progress'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
