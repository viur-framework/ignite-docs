...
$pyjs['loaded_modules']['html5.details'] = function (__mod_name__) {
	...
	try {
		...
		$m['Details'] = (function(){
			...
			$cls_definition['__md5__'] = '0397ab4ff9f14899be93f1ac1ac8974c';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0397ab4ff9f14899be93f1ac1ac8974c') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Details'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('_getOpen', function() {
				...
				return ($p['bool'](self['element']['hasAttribute']('open'))? (true) : (false));
			}
	, 1, [null,null,['self']]);
