...
$pyjs['loaded_modules']['html5.svg'] = function (__mod_name__) {
	...
	try {
		...
		$m['Svg'] = (function(){
			...
			$cls_definition['__md5__'] = '0b5afb2d886b08aa834409a6d1678871';
			...
			$method = $pyjs__bind_method2('__init__', function(version, viewBox, heigth, width) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0b5afb2d886b08aa834409a6d1678871') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Svg'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self'],['version', null],['viewBox', null],['heigth', null],['width', null]]);
			...
			$method = $pyjs__bind_method2('_getVersion', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'version');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getXmlns', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'xmlns');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['SvgCircle'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = 'a7cac23598a3253ce533f97f69f94d12';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'a7cac23598a3253ce533f97f69f94d12') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgCircle'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
		...
		$m['SvgEllipse'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = 'c400fdc02f49888e716c9105c717e900';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'c400fdc02f49888e716c9105c717e900') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgEllipse'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
		...
		$m['SvgG'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '51c06790d7f851fccf5888b82f366b97';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '51c06790d7f851fccf5888b82f366b97') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgG'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
			$method = $pyjs__bind_method2('_getTransform', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'transform');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['SvgImage'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '8be1c0bb1e050a5dd7c07109e6761e54';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '8be1c0bb1e050a5dd7c07109e6761e54') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgImage'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
		...
		$m['SvgLine'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '38d4b7dad6f14e5288770dda12c36597';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '38d4b7dad6f14e5288770dda12c36597') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgLine'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
		...
		$m['SvgPath'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '88cbde2220f7b86190c476c7067d377a';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '88cbde2220f7b86190c476c7067d377a') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgPath'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
			$method = $pyjs__bind_method2('_getD', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'd');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getPathLength', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'pathLength');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['SvgPolygon'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '8816df9d7a990b5744c7312eeeeaea66';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '8816df9d7a990b5744c7312eeeeaea66') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgPolygon'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
		...
		$m['SvgPolyline'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '282b5c503195be172a352220198b3227';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '282b5c503195be172a352220198b3227') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgPolyline'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
		...
		$m['SvgRect'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '3c2f08dc7cf7dd7b3de5d59e6408f9bc';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '3c2f08dc7cf7dd7b3de5d59e6408f9bc') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgRect'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			$cls_definition['__init__'] = $method;
		...
		$m['SvgText'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.svg';
			$cls_definition['__md5__'] = '541ed6755696442bbc91dc41da70317e';
			...
			$method = $pyjs__bind_method2('__init__', function(text) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '541ed6755696442bbc91dc41da70317e') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['SvgText'], self), '__init__', args, kwargs, [{}]);
				self['element']['appendChild']((typeof eval == "undefined"?$m['eval']:eval)("document.createTextNode('{}')"['format'](text)));
				return null;
			}
