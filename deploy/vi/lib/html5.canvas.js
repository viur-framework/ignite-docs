...
$pyjs['loaded_modules']['html5.canvas'] = function (__mod_name__) {
	...
	try {
		...
		$m['Canvas'] = (function(){
			...
			$cls_definition['__md5__'] = '418942715920bbed59325725161a1788';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '418942715920bbed59325725161a1788') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Canvas'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
