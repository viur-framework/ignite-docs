...
$pyjs['loaded_modules']['html5.ins'] = function (__mod_name__) {
	...
	try {
		...
		$m['Ins'] = (function(){
			...
			$cls_definition['__md5__'] = '4fde08e1dd37dcdcae8650abcbf97356';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '4fde08e1dd37dcdcae8650abcbf97356') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Ins'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
