...
$pyjs['loaded_modules']['html5.html5Attr.svg'] = function (__mod_name__) {
	...
	try {
		...
		$m['ViewBox'] = (function(){
			...
			$cls_definition['__md5__'] = 'dab690039927941689a849953dcc0f1a';
			$method = $pyjs__bind_method2('_getViewBox', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'dab690039927941689a849953dcc0f1a') {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'viewBox');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getPreserveAspectRatio', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'preserveAspectRatio');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['Dimensions'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.html5Attr.svg';
			$cls_definition['__md5__'] = '16bad85e264db10c4aa8cc1690ae6396';
			$method = $pyjs__bind_method2('_getWidth', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '16bad85e264db10c4aa8cc1690ae6396') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getX', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'x');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getY', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'y');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getR', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'r');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getRx', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'rx');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getRy', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'ry');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getCx', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'cx');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getCy', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'cy');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['Points'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.html5Attr.svg';
			$cls_definition['__md5__'] = '0a07838efcba5b7241fc9e0d26617891';
			$method = $pyjs__bind_method2('_getPoints', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0a07838efcba5b7241fc9e0d26617891') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'points');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getX1', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'x1');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getY1', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'y1');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getX2', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'x2');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getY2', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'y2');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['Transform'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.html5Attr.svg';
			$cls_definition['__md5__'] = '441649b9e80e2e03f551b0c04ef6be52';
			$method = $pyjs__bind_method2('_getTransform', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '441649b9e80e2e03f551b0c04ef6be52') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['Xlink'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.html5Attr.svg';
			$cls_definition['__md5__'] = 'd8f9db900461fe785bdd4237d93de221';
			$method = $pyjs__bind_method2('_getXlinkhref', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'd8f9db900461fe785bdd4237d93de221') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['val']]);
		...
		$m['Styles'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'html5.html5Attr.svg';
			$cls_definition['__md5__'] = 'fe698525ae75ae6cc996a3174f885043';
			$method = $pyjs__bind_method2('_getFill', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'fe698525ae75ae6cc996a3174f885043') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'fill');
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getStroke', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'stroke');
			}
	, 1, [null,null,['self']]);
