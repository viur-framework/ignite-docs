...
$pyjs['loaded_modules']['html5.bdo'] = function (__mod_name__) {
	...
	try {
		...
		$m['Bdo'] = (function(){
			...
			$cls_definition['__md5__'] = '8f2d1aae3dcd344caca8f3e80beaface';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '8f2d1aae3dcd344caca8f3e80beaface') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Bdo'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
