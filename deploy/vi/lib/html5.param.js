...
$pyjs['loaded_modules']['html5.param'] = function (__mod_name__) {
	...
	$m.__track_lines__[1] = 'html5.param.py, line 1:\n    from html5.widget import Widget';
	$m.__track_lines__[2] = 'html5.param.py, line 2:\n    from html5.html5Attr.form import Name,Value';
	$m.__track_lines__[4] = 'html5.param.py, line 4:\n    class Param( Widget,Name,Value ):';
	$m.__track_lines__[5] = 'html5.param.py, line 5:\n    _baseClass = "param"';
	$m.__track_lines__[7] = 'html5.param.py, line 7:\n    def __init__(self, *args, **kwargs):';
	$m.__track_lines__[8] = 'html5.param.py, line 8:\n    super(Param,self).__init__( *args, **kwargs )';


	$pyjs['track']['module']='html5.param';
	$pyjs['track']['lineno']=1;
	$pyjs['track']['lineno']=1;
	...
	$m['Param'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$pyjs['track']={'module':'html5.param', 'lineno':7};$pyjs['trackstack']['push']($pyjs['track']);
			$pyjs['track']['module']='html5.param';
			$pyjs['track']['lineno']=7;
			$pyjs['track']['lineno']=8;
			(function(){try{try{$pyjs['in_try_except'] += 1;
			return $pyjs_kwargs_call((function(){try{try{$pyjs['in_try_except'] += 1;
			return $p['$$super']($m['Param'], self);
