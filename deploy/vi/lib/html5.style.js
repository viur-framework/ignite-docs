...
$pyjs['loaded_modules']['html5.style'] = function (__mod_name__) {
	...
	try {
		...
		$m['Style'] = (function(){
			...
			$cls_definition['__md5__'] = '408efa2133caddecd5c64428c6d51ce2';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '408efa2133caddecd5c64428c6d51ce2') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Style'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('_getScoped', function() {
				...
				return ($p['bool'](self['element']['hasAttribute']('scoped'))? (true) : (false));
			}
	, 1, [null,null,['self']]);
