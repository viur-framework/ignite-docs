...
$pyjs['loaded_modules']['html5.iframe'] = function (__mod_name__) {
	...
	try {
		...
		$m['Iframe'] = (function(){
			...
			$cls_definition['__md5__'] = '1ef74cb702f8cfba43fc492b5b66e1fd';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '1ef74cb702f8cfba43fc492b5b66e1fd') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Iframe'], self), '__init__', args, kwargs, [{}]);
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('_getSandbox', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'sandbox');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setSandbox', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('sandbox', val) : $p['setattr']($p['getattr'](self, 'element'), 'sandbox', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getSrcdoc', function() {
				...
				return $p['getattr']($p['getattr'](self, 'element'), 'src');
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('_setSrcdoc', function(val) {
				...
				$p['getattr'](self, 'element')['__is_instance__'] && typeof $p['getattr'](self, 'element')['__setattr__'] == 'function' ? $p['getattr'](self, 'element')['__setattr__']('src', val) : $p['setattr']($p['getattr'](self, 'element'), 'src', val); 
				return null;
			}
	, 1, [null,null,['self'],['val']]);
			...
			$method = $pyjs__bind_method2('_getSeamless', function() {
				...
				return ($p['bool'](self['element']['hasAttribute']('seamless'))? (true) : (false));
			}
	, 1, [null,null,['self']]);
