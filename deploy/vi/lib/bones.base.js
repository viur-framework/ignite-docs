...
$pyjs['loaded_modules']['bones.base'] = function (__mod_name__) {
	...
	try {
		...
		$m['BaseBoneExtractor'] = (function(){
			...
			$cls_definition['__md5__'] = '1893ff0440fb41a8542cd02459998138';
			$method = $pyjs__bind_method2('__init__', function(moduleName, boneName, skelStructure) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '1893ff0440fb41a8542cd02459998138') {
				...
				$p['$$super']($m['BaseBoneExtractor'], self)['__init__']();
	...
	, 1, [null,null,['self'],['data'],['field']]);
		...
		$m['BaseViewBoneDelegate'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'bones.base';
			$cls_definition['__md5__'] = '17dbdc901a42de2a1648cd4a30ec5deb';
			$method = $pyjs__bind_method2('__init__', function(moduleName, boneName, skelStructure) {
				if (this['__is_instance__'] === true) {
					var self = this;
					var args = $p['tuple']($pyjs_array_slice['call'](arguments,3,arguments['length']-1));
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '17dbdc901a42de2a1648cd4a30ec5deb') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$p['$$super']($m['BaseViewBoneDelegate'], self)['__init__']();
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('skelStructure', skelStructure) : $p['setattr'](self, 'skelStructure', skelStructure); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('boneName', boneName) : $p['setattr'](self, 'boneName', boneName); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('moduleName', moduleName) : $p['setattr'](self, 'moduleName', moduleName); 
				return null;
	...
	, 1, [null,null,['self'],['data'],['field']]);
		...
		$m['BaseEditBone'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'bones.base';
			$cls_definition['__md5__'] = 'dd4d83cac0b424b05199488821d06120';
			$method = $pyjs__bind_method2('__init__', function(moduleName, boneName, readOnly) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'dd4d83cac0b424b05199488821d06120') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$pyjs_kwargs_call($p['$$super']($m['BaseEditBone'], self), '__init__', args, kwargs, [{}]);
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('boneName', boneName) : $p['setattr'](self, 'boneName', boneName); 
	...
	, 1, ['args',['kwargs'],['self'],['moduleName'],['boneName'],['readOnly']]);
			...
			$method = $pyjs__bind_method2('fromSkelStructure', function(moduleName, boneName, skelStructure) {
				...
				return $m['BaseEditBone'](moduleName, boneName, skelStructure['__getitem__'](boneName)['get']('readonly', false));
			}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('unserialize', function(data, extendedErrorInformation) {
				...
				if ($p['bool'](data['keys']()['__contains__']($p['getattr'](self, 'boneName')))) {
					self['__setitem__']('value', data['get']($p['getattr'](self, 'boneName'), ''));
				}
				return null;
			}
				...
				kwargs = $p['__empty_dict']();
{
		...
		$m['editBoneSelector']['insert']($constant_int_0, $lambda1, $m['BaseEditBone']);
				...
				kwargs = $p['__empty_dict']();
{
		...
		$m['viewDelegateSelector']['insert']($constant_int_0, $lambda2, $m['BaseViewBoneDelegate']);
				...
				kwargs = $p['__empty_dict']();
{
		...
		$lambda3['__args__'] = ['args',['kwargs']];
		$m['extractorDelegateSelector']['insert']($constant_int_0, $lambda3, $m['BaseBoneExtractor']);
