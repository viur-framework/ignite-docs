...
$pyjs['loaded_modules']['screen'] = function (__mod_name__) {
	...
	try {
		...
		$m['Screen'] = (function(){
			...
			$cls_definition['__md5__'] = '65cd6d70ecb76f9059a59310c9459e17';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '65cd6d70ecb76f9059a59310c9459e17') {
				...
				$pyjs_kwargs_call($p['$$super']($m['Screen'], self), '__init__', args, kwargs, [{}]);
				self['addClass']('vi-screen');
				$m['conf']['__getitem__']('theApp')['appendChild'](self);
				self['hide']();
				return null;
			}
	, 1, ['args',['kwargs'],['self']]);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('invoke', function() {
				...
				$p['printFunc']([$p['sprintf']('Invoke: %s', $p['getattr']($p['getattr'](self, '__class__'), '__name__'))], 1);
				return null;
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('setTitle', function(title) {
				...
				if ($p['bool']($p['op_is'](title, null))) {
					title = $p['getattr']($p['getattr'](self, '__class__'), '__name__');
				}
				$m['conf']['__getitem__']('theApp')['setTitle'](title);
				return null;
			}
